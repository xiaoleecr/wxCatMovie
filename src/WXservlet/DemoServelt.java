...
public class DemoServelt extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		/*
		 * // 第三方用户唯一凭证 String appId = "wxd42462bf296501b1"; // 第三方用户唯一凭证密钥
		 * String appSecret = "35104c6c8a3a2f5cebccb1a5b6f745e3";
		 * 
		 * // 调用接口获取access_token AccessToken at =
		 * WeixinUtil.getAccessToken(appId, appSecret);
		 */
	...
	private static Menu getMenu() {
		...
		btn12.setType("view");
		btn12.setKey("12");
		btn12.setUrl("http://8icgdh.natappfree.cc/wxCatMovie/go");
